...
key_bindings_init(void)
{
	static const char *const defaults[] = {
		/* Prefix keys — F-keys cover splits/nav/zoom; keep essentials only. */
		...
		/* Help popup (F1). */
		"bind -N 'Quick reference' -n F1 "
		    "{ display-popup -w 72 -h 42 -b rounded "
		    "-S 'fg=colour59' "
		    "-T '#[align=centre,fg=green,bold] tmux-custom ' "
		    "-E 'printf \""
		    "\\n"
		    "\\033[1m                  tmux-custom  \\033[32m·\\033[0;1m  Quick Reference\\033[0m\\n"
		    "\\n"
		    "  \\033[1mTHE PATTERN\\033[0m\\n"
		    "  \\033[2m─────────────────────────────────────────────────────────────\\033[0m\\n"
		    "  plain \\033[2m→\\033[0m \\033[1mwindows\\033[0m     \\033[33m⇧\\033[0m Shift \\033[2m→\\033[0m \\033[1mpanes\\033[0m     \\033[33m⌃\\033[0m Ctrl \\033[2m→\\033[0m \\033[1mpower\\033[0m\\n"
		    "\\n"
		    "  \\033[1mMNEMONICS\\033[0m\\n"
		    "  \\033[2m─────────────────────────────────────────────────────────────\\033[0m\\n"
		    "  \\033[1;32mF2\\033[0m=Two  \\033[1;32mF3\\033[0m=Back  \\033[1;32mF4\\033[0m=Forth  \\033[1;32mF6\\033[0m=Exit  \\033[1;32mF7\\033[0m=Rewind  \\033[1;32mF8\\033[0m=Label\\n"
		    "\\n"
		    "  \\033[2m───\\033[0m \\033[1mF-KEYS\\033[0m \\033[2m────────────────────────────── no prefix needed ──\\033[0m\\n"
		    "\\n"
		    "   \\033[1;32mF2\\033[0m  New window        \\033[33m⌃\\033[1;32mF2\\033[0m  Split ←│→      \\033[33m⇧\\033[1;32mF2\\033[0m  Split ─┬─\\n"
		    "   \\033[1;32mF3\\033[0m  Prev window       \\033[33m⌃\\033[1;32mF3\\033[0m  Swap pane ←    \\033[33m⇧\\033[1;32mF3\\033[0m  Prev pane\\n"
		    "   \\033[1;32mF4\\033[0m  Next window       \\033[33m⌃\\033[1;32mF4\\033[0m  Swap pane →    \\033[33m⇧\\033[1;32mF4\\033[0m  Next pane\\n"
		    "   \\033[1;32mF6\\033[0m  Detach            \\033[33m⌃\\033[1;32mF6\\033[0m  Kill pane\\n"
		    "   \\033[1;32mF7\\033[0m  Scroll mode                            \\033[33m⌥\\033[0mPgUp Scrollback\\n"
		    "   \\033[1;32mF8\\033[0m  Rename window     \\033[33m⌃\\033[1;32mF8\\033[0m  Rename sess    \\033[33m⇧\\033[1;32mF8\\033[0m  Cycle layout\\n"
		    "                         \\033[33m⌃⇧\\033[1;32mF3\\033[0m Move win ←    \\033[33m⇧\\033[1;32mF11\\033[0m Zoom pane\\n"
		    "                         \\033[33m⌃⇧\\033[1;32mF4\\033[0m Move win →    \\033[33m⌥\\033[1;32mF11\\033[0m Break pane\\n"
		    "\\n"
		    "  \\033[2m───\\033[0m \\033[1mARROWS\\033[0m \\033[2m───────────────────────────── no prefix needed ──\\033[0m\\n"
		    "\\n"
		    "   \\033[33m⇧\\033[0m ↑↓←→    Select pane         \\033[33m⌥\\033[0m ←→   Prev/next window\\n"
		    "   \\033[33m⌥⇧\\033[0m ↑↓←→   Resize pane         \\033[33m⌥\\033[0m ↑↓   Prev/next session\\n"
		    "\\n"
		    "  \\033[2m───\\033[0m \\033[1mPREFIX\\033[0m \\033[1;36m⌃B\\033[0m \\033[2m── then key ──────────────────────────────────\\033[0m\\n"
		    "\\n"
		    "   \\033[1;36mc\\033[0m  New window     \\033[1;36m%%\\033[0m  Split ←→     \\033[1;36mz\\033[0m  Zoom       \\033[1;36md\\033[0m  Detach\\n"
		    "   \\033[1;36mn\\033[0m  Next win       \\033[1;36m\\\\\\\"\\033[0m  Split ↑↓     \\033[1;36mx\\033[0m  Kill pane  \\033[1;36m[\\033[0m  Copy mode\\n"
		    "   \\033[1;36mp\\033[0m  Prev win       \\033[1;36m,\\033[0m  Rename       \\033[1;36mw\\033[0m  Windows    \\033[1;36m:\\033[0m  Command\\n"
		    "   \\033[1;36m0-9\\033[0m Jump to #    \\033[1;36ms\\033[0m  Sessions     \\033[1;36m?\\033[0m  All keys\\n"
		    "\\n"
		    "  \\033[2m───\\033[0m \\033[1mWORKFLOW\\033[0m \\033[2m── Side-by-Side ────────────────────────────────\\033[0m\\n"
		    "\\n"
		    "   \\033[33m⌃\\033[1;32mF2\\033[0m split  \\033[2m→\\033[0m  \\033[33m⇧\\033[1;32mF3\\033[0m/\\033[33m⇧\\033[1;32mF4\\033[0m switch  \\033[2m→\\033[0m  \\033[33m⌃\\033[1;32mF6\\033[0m close pane\\n"
		    "\\n"
		    "\\033[2m                     mouse: on  ·  q to close\\033[0m\\n"
		    "\" | less -R' }",

		/* Byobu-style F-key bindings (no prefix required). */
		"bind -N 'New window' -n F2 { new-window -c '#{pane_current_path}' }",
		"bind -N 'Split horizontally' -n C-F2 { split-window -h -c '#{pane_current_path}' }",
		"bind -N 'Split vertically' -n S-F2 { split-window -v -c '#{pane_current_path}' }",
		"bind -N 'Previous window' -n F3 { previous-window }",
		"bind -N 'Next window' -n F4 { next-window }",
		"bind -N 'Previous pane' -n S-F3 { select-pane -t :.- }",
		"bind -N 'Next pane' -n S-F4 { select-pane -t :.+ }",
		"bind -N 'Swap pane backward' -n C-F3 { swap-pane -s :. -t :.-; select-pane -t :.- }",
		"bind -N 'Swap pane forward' -n C-F4 { swap-pane -s :. -t :.+; select-pane -t :.+ }",
		"bind -N 'Move window left' -n C-S-F3 { swap-window -t :-1 -d }",
		"bind -N 'Move window right' -n C-S-F4 { swap-window -t :+1 -d }",
		"bind -N 'Detach' -n F6 { detach-client }",
		"bind -N 'Kill pane' -n C-F6 { kill-pane }",
		"bind -N 'Enter copy mode' -n F7 { copy-mode }",
		"bind -N 'Rename window' -n F8 { command-prompt -p'(rename-window)' { rename-window -- '%%' } }",
		"bind -N 'Rename session' -n C-F8 { command-prompt -p'(rename-session)' { rename-session -- '%%' } }",
		"bind -N 'Cycle layout' -n S-F8 { next-layout }",
		...
		"bind -N 'Select pane above' -n S-Up { select-pane -U }",
		"bind -N 'Select pane below' -n S-Down { select-pane -D }",
		"bind -N 'Select pane left' -n S-Left { select-pane -L }",
		"bind -N 'Select pane right' -n S-Right { select-pane -R }",
